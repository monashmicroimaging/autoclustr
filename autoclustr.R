...
load_localisations <- function(localisations_dir) {
  ...
  ppps <- read.moleculelists(file.path(localisations_dir, localisation_fns), 
                             rdr = read.moleculelist_rapidstorm)
...
# ------------------------------------------------------------------------------
# Analysis
process_dir <- function(input_dir, output_dir_name, roi_xy_pix_size = 5,
  ...
  ppps <- load_localisations(localisations_dir)
